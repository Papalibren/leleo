    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <?= $form->field($model, 'mating_contacts')->textarea([
                'rows' => 2,
                'placeholder' => 'Контактная информация для владельцев котов/кошек'
            ]) ?>
        </div>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <?= $form->field($model, 'additional_info')->textarea([
                'rows' => 3,
                'placeholder' => 'Дополнительная информация о кошке'
            ]) ?>
