...
<div class="dog-form">
    ...
    <?= $form->field($model, 'height_cm')->input('number')  ?>
    <?= $form->field($model, 'weight_kg')->input('number')  ?>
    ...
    <?php if (isset($this->params['action']) && $this->params['action'] === 'update'): ?>
        <div class="col-sm-8 d-flex flex-column gap-2 align-items-start dog-owner_id-mx-box" hx-get="/mx/dog/create/select-owner?owner_id=<?= $model->owner->id ?>" hx-trigger="load" hw-swap="outerHTML">
        </div>
    <?php endif ?>
            ...
            <form id="self-add-father-form" hx-post="/mx/dog/create/add-father" hx-target=".dog-father_id-mx-box" hx-on::after-request="closeModal('fatherModal')">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select modal-color-select" name="color_id" required
                            data-breed-select="#dog-breed">
