<?php if (!empty($users)): ?>
    <form class="d-flex" hx-get="/mx/dog/create/select-owner" hx-target=".dog-owner_id-mx-box">
        <select class="form-select" name="owner_id" id="dog-search-result-owner">
    ...
    <div class="modal fade" id="ownerModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="owner-form" hx-post="/mx/dog/create/add-owner" hx-target=".dog-owner_id-mx-box" hx-on::before-cleanup-element="closeModal('ownerModal')">
