<?php if (!empty($cats)): ?>
    <form class="d-flex" hx-get="/mx/cat/create/select-father" hx-target=".cat-father_id-mx-box">
        <select class="form-select" name="father_id" id="cat-search-result-father">
