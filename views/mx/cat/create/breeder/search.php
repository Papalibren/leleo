<?php if (!empty($users)): ?>
    <form class="d-flex" hx-get="/mx/cat/create/select-breeder" hx-target=".cat-breeder_id-mx-box">
        <select class="form-select" name="breeder_id" id="cat-search-result-breeder">
    ...
    <div class="modal fade" id="breederModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="breeder-form" hx-post="/mx/cat/create/add-breeder" hx-target=".cat-breeder_id-mx-box" hx-on::before-cleanup-element="closeModal('breederModal')">
