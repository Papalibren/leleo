<?php
// controllers/user/DogAdController.php
...
/**
 * DogAdController implements the CRUD actions for Dog advertisements.
 */
class DogAdController extends Controller
{
    public $layout = 'user';
    ...
    {
        $model = Dog::findOne(['id' => $id, 'owner_id' => Yii::$app->user->id]);
        if (!$model) {
            throw new NotFoundHttpException('Собака не найдена или доступ запрещён.');
        }
        return $model;
    }
}